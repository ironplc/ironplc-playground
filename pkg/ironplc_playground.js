 ...
 * @param {string} bytecode_base64
 * @param {number} scans
 * @returns {string}
 */
export function run(bytecode_base64, scans) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(bytecode_base64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.run(ptr0, len0, scans);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function step(scans) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.step(scans);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./ironplc_playground_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ironplc_playground_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
